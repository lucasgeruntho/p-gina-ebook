...
while ($row = $result->fetch_assoc()) {
    ...
    $mensagem = "🔔 $nome, já se passaram 30 minutos desde que você chegou. Aproveite para garantir sua coleção de receitas de chocolate agora! 🍫 👉 https://receitasdechocolate.shop";
